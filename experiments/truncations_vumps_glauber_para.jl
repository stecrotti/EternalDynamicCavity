...
β = 1.0
h = 0.2
f = HomogeneousGlauberFactor(J, h, β)
...
savefig(pl, (@__DIR__)*"/vumps_glauber_para.pdf")
...
savefig(pl_ps, "vumps_glauber_bonddims_para.pdf")

jldsave((@__DIR__)*"/../data/vumps_glauber_para.jld2"; J, h, β, ds, A0, ε, err, ovl, bel, AA, A, maxiter, ps, m_ss)
